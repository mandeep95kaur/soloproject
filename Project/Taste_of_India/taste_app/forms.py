...
class CustomerRegistrationForm(UserCreationForm):
    ...
    password2 = forms.CharField(label='Conform Password', widget=forms.
    PasswordInput(attrs={'class':'form-control'}))
...
class MyPasswordChangedForm(PasswordChangeForm):
    ...
    new_password2 = forms.CharField(label='Conform Password', strip=False, widget=forms.PasswordInput(attrs=
    {'autocomplete':'new-password', 'class':'form-control'}))
